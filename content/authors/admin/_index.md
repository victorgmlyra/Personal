...
awards:
  - title: Best Research Paper (SVR 2020)
    url: https://svr2020.cin.ufpe.br/
    date: '2020-10-10'
    awarder: Symposium on Virtual and Augmented Reality (SVR)
    # icon: coursera
    summary: |
      Awarded The best research paper of the XXII Symposium on Virtual and Augmented Reality (SVR 2020) with the work "Development of an efficient 3D reconstruction solution from permissive open-source code".
  - title: 3rd Place in OpenCV's Spatial AI Competition
    url: https://opencv.org/blog/opencv-spatial-al-competition-winners-announced/
    date: '2020-10-18'
    awarder: OpenCV
    # icon: edx
    summary: |
      Won 3rd place in the first international OpenCV Spatial AI Competition out of 235 submissions. We developed an At Home Workout Assistant using 3D information from OpenCV's OAK-d stereo camera. it estimates the person’s 3D human pose and analyzes the skeleton’s movements, returning the appropriate feedback to help the user to perform an exercise correctly.
---
